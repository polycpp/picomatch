# Sphinx configuration for the picomatch companion library.
#
...
html_theme_options = {
    ...
    'source_repository': 'https://github.com/polycpp/picomatch',
...
html_baseurl = 'https://polycpp.github.io/picomatch/'
